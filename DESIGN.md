---
version: alpha
name: NOT Drones internal design system (inspired by Vercel)
...
<!-- design-md provenance
  source: https://github.com/VoltAgent/awesome-design-md/blob/main/design-md/vercel/DESIGN.md  (MIT; an "inspired interpretation" of vercel)
  preview: https://getdesign.md/vercel/design-md
  fetched: 2026-09-11
...
- 2026-09-12: renamed for NOT Drones. Applied first to internal/roadmap/ (hidden ops page). Added three semantic ORIGIN tokens on top of the system scales — imported/Chinese = red (`#c50000` ink, `#f7d4d6` soft), in-house NDIPL = green (`#1a7f37` ink, `#d6f5df` soft), unknown = amber (`#ab570a` ink, `#ffefcf` soft) — because the roadmap's whole story is origin coding; the template's blue `success` token is NOT used for success/in-house (blue stays for links only). Dropped the mesh-gradient hero (internal tool, no marketing surface). Fonts: Geist + Geist Mono from Google Fonts.
- 2026-09-11: fetched from awesome-design-md/vercel; no adaptations yet.
